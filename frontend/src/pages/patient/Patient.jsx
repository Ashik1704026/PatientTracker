    ...
    <body>
      <header className="bg_image">
        ...
        <div className="container"style={{marginTop:'100px'}}>
          <div className="carddoc card" style={{ height: "230px" , backgroundColor: "rgba(245, 245, 245, 0.4)" , }}>
            <div className="row">
              <div className="col-md-2 text-center">
                <button type="button" onClick={toggleModal} className="btn btn-primary" data-bs-toggle="modal"
                  data-bs-target="#exampleModal" style={{ marginTop: "50%" }}>
              ...
              <div className="col-md-4 d-none d-lg-block mt-5">
                ...
                <h5 className="mx-5 my-3">Phone:{patientPayload != null? patientPayload.patientInfo.phone: ""}</h5>
              </div>
              <div className=" item col-md-2" style={{ padding: "2px 15px 50px 5px" }}>
              {/* {patientPayload != null? patientPayload.patientInfo.profile: ""} */}
                <img src={pimg} className=" img-fluid rounded-circle card-img d-none d-lg-block " style={{
                   padding: "12px 12px 12px 12px" , height: "230px" , border: "2px solid #555" ,
                  boxShadow: "2px 2px 1px 1px black" , }} alt="..." />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container  my-4  mt-4">
        <div className="overflow-scroll card pcard1">
          ...
          {
          patientPayload != null
          ? patientPayload.history.map(
          (val) => (
          <div className="card my-2 mx-2" style={{boxShadow: "2px 2px 1px 1px black"}}>
            <div className="row">
     ...
     {/* /////diagnosis////// */}
              ...
              <div className="col-md-2 my-2">
                ...
                // console.log(val3)
                <div className="dropdown mx-0 my-2">
                <button className="btn dropdown-toggle" type="button" data-mdb-toggle="dropdown"
                  aria-expanded="false">
                {val3.name}
                </button>
                    ...
                    <ul class="dropdown-item dropdown-submenu">
                      {
                        ...
                        <li>
                            <a class="dropdown-item" href="#">{val4}</a>
                        </li>
                        )
                      }
                    </ul>
